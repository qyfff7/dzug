...
type Video struct {
	...
	PlayUrl       string `gorm:"column:play_url;type:varchar(255);comment:视频地址;NOT NULL" json:"play_url"`
	CoverUrl      string `gorm:"column:cover_url;type:varchar(255);comment:封面地址;NOT NULL" json:"cover_url"`

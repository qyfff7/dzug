...
func (x *LoginAndRegisterResponse) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type User struct {
	...
	WorkCount       *int64  `protobuf:"varint,10,opt,name=work_count,json=workCount,proto3,oneof" json:"work_count,omitempty"`                 //作品数
...
type UserMapRequest struct {
	...
	UserIds []uint64 `protobuf:"varint,1,rep,packed,name=user_ids,json=userIds,proto3" json:"user_ids,omitempty"` // 用户ID 列表
	// 用户鉴权Token [注：这里用 validate，是因为内部方法也必须要用到 Token，并不是所有 token 都 validate]
	Token string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"`
}
...
func (x *UserMapRequest) GetUserIds() []uint64 {
	if x != nil {
		return x.UserIds
	}
	return nil
...
type UserMapResponse struct {
	...
	// 用户列表：map[userId] = User
	UserMap map[uint64]*User `protobuf:"bytes,1,rep,name=user_map,json=userMap,proto3" json:"user_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *UserMapResponse) GetUserMap() map[uint64]*User {
	if x != nil {
		return x.UserMap
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x91, 0x04, 0x0a, 0x04,
	...
	0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x14,

...
type AccountReq struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty" binding:"required,max=32" form:"username"` // 用户名
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" binding:"required,max=32" form:"password"` // 密码
}
